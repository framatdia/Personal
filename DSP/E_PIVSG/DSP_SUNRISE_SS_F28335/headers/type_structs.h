...
/*  CTRL code
    ...
    6 -> E-PI-Grid-Forming PI-VSG (PQ in W/var)
    */
...
#define I_pk_max        100          //40 Maximum peak current
...
#define Kp_p            0.01 // Proportional gain active power control loop
#define Ki_p            0.1 // Integral gain active power control loop 1/(2H). H inertia constant
...
#define tau_vsg         0.02 // time constant LPF voltages/current dq

// E-PI Virtual Synchronous generator gains
#define T_filter        0.00070665 //time constan HPF and LPF
#define Gain_hpf        32.2513 // Gain LPF
#define Gain_lpf        0.0071  // Gain HPF
#define F               -0.0022 // Proportional gain of E-PI-VSG
#define K               0.0071 //Gain of the E-PI-VSG
// import math.h
#define __BSD_VISIBLE
#include "math.h"

// Definition of structures
//Structures: They are a way to group several related variables into one place. Each variable in the structure is known as a member of the structure.
