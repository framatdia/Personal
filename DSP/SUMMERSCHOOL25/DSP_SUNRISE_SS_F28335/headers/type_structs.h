...
#define     OFF_IN          -0.5 //offset for the neutral current of the VSC
...
#define		OFF_IC			-0.46 //offset for the current c of the VSC
#define		GAIN_VC			0.9977 //gain for the voltage c of the VSC
#define		OFF_VC			-3.5 //offset for the voltage c of the VSC
#define		GAIN_IB			1 //gain for the current b of the VSC
#define		OFF_IB			-0.6 //offset for the current b of the VSC
#define		GAIN_VB			0.9977 //gain for the voltage b of the VSC
#define		OFF_VB			-2.5 //offset for the voltage b of the VSC
#define		GAIN_IA			1.0101 //gain for the current a of the VSC
#define		OFF_IA			0 //offset for the current c of the VSC
#define		GAIN_VA			1.0106 //gain for the voltage a of the VSC
#define		OFF_VA			-2.2 //offset for the voltage b of the VSC
...
// Rotation matrix
#define c120          -0.5 //cosine of 120º. Helps reduce the number of sine and cosine operations in transforms
...
struct references{
    ...
    double id_ref, iq_ref, p_ref, q_ref, vdc_ref, etas;
};
